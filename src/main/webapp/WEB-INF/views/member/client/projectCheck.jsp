      ...
      <div class="modal-dialog">
         ...
         <div class="modal-content">
           ...
           <tr>
              ...
              <td style="text-align: center;"><input id="aa${o.index }" type="text" name="pay"class="form-control"></td>
           </tr>
           </c:if>
           </c:forEach>
           ...
           <div class="modal-footer">
              <button class="okbtn2 btn btn-default" title="${o.index }" type="button" class="btn btn-default">확인</button>
...
$(".okbtn2").click(function() {
   ...
   if(pay2 != "" && startDate !="" && finishDate != "" && datecheck ==0){
